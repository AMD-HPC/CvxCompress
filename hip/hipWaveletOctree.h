...
// 4096 B/block significance bitmap with a
...
// significance length in sig_sizes[bid]. Width-table and value coding are
// omitted from this prototype, which validates the significance round-trip.
//
